...
/**
* @see \App\Http\Controllers\Admin\PinSessionController::create
...
/**
* @see \App\Http\Controllers\Admin\PinSessionController::destroy
...
const PinSessionController = { create, store, destroy }

export default PinSessionController