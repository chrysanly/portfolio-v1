...
final class ProfileFactRequest extends FormRequest
{
    ...
    public function rules(PinVerifier $pinVerifier): array
    {
        return [
            ...
            'label' => ['required', 'string', 'max:60', Rule::unique('profile_facts', 'label')->ignore($this->route('profile_fact'))],
